...
var BHPositions [8]float // x1,y1, x2,y2, x3,y3, x4,y4
var OrbitRadii [4]float  // radius1, radius2, radius3, radius4
var Strengths [4]float   // strength1, strength2, strength3, strength4
